...
public class FileUtil {
	...
	private static final String ABS_PATH = "E:\\Clean_WorkSpace\\online-shopping\\onlineshopping\\src\\main\\webapp\\assets\\images";
	...
	public static boolean uploadFile(HttpServletRequest request, MultipartFile file, String code) {
		...
		// creer les dossier si il nexite pas
		...
		try {
			// transferer les fichier dans les dossiers
