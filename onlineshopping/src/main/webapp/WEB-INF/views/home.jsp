				...
				<div class="col-md-12">
					<div id="carousel-example-generic" class="carousel slide"
						...
						<div class="carousel-inner">
							...
							<div class="item">
								<img class="slide-image" src="${images}/banner9.jpg"
									alt="">
							</div>
							<div class="item">
								<img class="slide-image" src="${images}/banner10.jpg"
									alt="">
							</div>
								...
								<img class="slide-image" src="${images}/banner12.jpg"
									alt=""></div>
									<div class="item">
								<img class="slide-image" src="${images}/banner13.jpg"
									alt=""></div>
									<div class="item">
								<img class="slide-image" src="${images}/banner16.jpg"
									alt=""></div>
                ...
                <div class="row is-table-row">
                    ...
                    <div class="col-sm-4" ng-repeat="product in pCtrl.mvProducts">                    	
                        <div class="thumbnail">
                            ...
                            <hr/>
                            <div class="caption">
                                <h4 class="pull-right">&euro; {{product.unitPrice}}</h4>
