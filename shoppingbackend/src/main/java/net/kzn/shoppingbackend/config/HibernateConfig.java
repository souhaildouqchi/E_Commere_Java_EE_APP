...
// on a cree un bean qui doit etre gerer par spring
@Configuration
// ou se trouve entity classe que hibernate a besoin 
...
public class HibernateConfig {
	...
	// dataSource bean will be available accross the application
	@Bean("dataSource")
